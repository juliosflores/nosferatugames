export default async function handler(req, res) {
  ...
  try {
    ...
    // O Session Token que capturamos do seu navegador
...
Regras: identifique o título exato pela capa. Se seminovo/usado mencione conservação. Preço justo de mercado BR.`;
    ...
    try {
      console.log('Trying Aurora HTTPS with Token...');
      ...
      if (resp.ok) {
        ...
        console.log('Aurora Error:', resp.status, errText);
      }
    } catch (e) {
      console.log('Aurora Connection Failed:', e.message);
    }
