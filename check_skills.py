...
script = """
echo 96979032 | sudo -S curl -s -H "Authorization: Bearer Xi9f0bXa13x5FnqUAV3k7tDiLxdSyNA8MLbxXRbSB3Y" http://localhost:9119/api/skills | grep "nosferatu-relatorio-diario"
"""
